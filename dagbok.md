...
**Markmið**:
Skipuleggja verkefnaskiptingu, byrja á kóðanum og koma öllum inn í git repo-ið.
...
**Niðurstaða**\
Unnum að heiman, sumir farnir til Amsterdam og aðrir veikir.
...
**Niðurstaða**:
Unnum að heiman, sumir á leiðinni til landsins.
...
**Niðurstaða**:\
Mættum frá 9-10, unnum í kóðanum og reyndum að klára A kröfurnar.
...
**Markmið**:
* Klára að kóða
* Byrja á að uppfæra hönnunarskýrsluna

**Niðurstaða**:\
Mættum frá 10-11, unnum við að klára fáu A kröfurnar sem eftir eru.
...
**Markmið**:
* Klára A kröfur
* Byrja að uppfæra hönnunarskýrsluna

**Niðurstaða**:\
Mættum frá 9-11 og fórum að vinna í kóðanum, kláruðum öll nema eitt fall sem við vorum samt byrjaðir að vinna í. Byrjuðum aðeins að vinna í uppfærðri hönnunarskýrslu. 
...
**Markmið**: 
* Klára að kóða
* Uppfæra hönnunarskýrslu
* Gera myndband
* Skila

**Niðurstaða**:\
Mættum frá 9-11, unnum við að klára seinasta fallið í kóðanum, uppfærðum hönnunarskýrsluna og fínpússuðum kóðann, löguðum villur sem komu upp og komum í veg fyrir það að forritið krassi ef það skyldi koma innsláttarvilla.
Tókum upp myndband um notkun forritsins, kláruðum það sem þurfti að gera fyrir skil og skiluðum.
